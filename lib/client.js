...
function CardMeta(props) {
  ...
  if (p.source === "github" && p.githubUrl) {
    ...
    return import_react.default.createElement(
      ...
      import_react.default.createElement("span", { className: "pmgr-meta-label" }, "\u6765\u6E90"),
      import_react.default.createElement("span", { className: "pmgr-meta-sep" }, "\xB7"),
      import_react.default.createElement(
        "a",
        { className: "pmgr-meta-link", href: p.githubUrl, target: "_blank", rel: "noreferrer", title: p.githubUrl },
        "GitHub \xB7 " + repo
      ),
      ref ? import_react.default.createElement(
        "span",
        {
  ...
  if (p.source === "npm") {
    return import_react.default.createElement(
      ...
      import_react.default.createElement("span", { className: "pmgr-meta-label" }, "\u6765\u6E90"),
      import_react.default.createElement("span", { className: "pmgr-meta-sep" }, "\xB7"),
      import_react.default.createElement("span", { className: "pmgr-meta-hash" }, "npm" + (p.name ? " \xB7 " + p.name : ""))
    );
  }
  if (p.source === "local") {
    return import_react.default.createElement(
      ...
      import_react.default.createElement("span", { className: "pmgr-meta-label" }, "\u6765\u6E90"),
      import_react.default.createElement("span", { className: "pmgr-meta-sep" }, "\xB7"),
      import_react.default.createElement("span", null, "\u672C\u5730\u8DEF\u5F84")
    );
  }
  return null;
}
...
function PluginManagerTab() {
  ...
  const renderRow = (p) => {
    ...
    const kindBadge = p.kind === "builtin" ? import_react.default.createElement(Badge, null, "\u5185\u7F6E") : import_react.default.createElement(Badge, null, "\u4E09\u65B9");
