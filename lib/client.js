...
function InstallDialog(props) {
  ...
  const resolveBare = (name) => {
    ...
    }).catch((e) => setErr(String(e && e.message || e))).finally(() => setResolving(false));
  };
  const doSearch = () => {
    setSearching(true);
    ...
    import_react2.default.createElement(
      ...
      mode === "direct" ? import_react2.default.createElement(
        ...
        import_react2.default.createElement(
          ...
          import_react2.default.createElement("button", { className: "pmgr-btn pmgr-btn-primary", disabled: busy !== null || resolving, onClick: doInstall }, resolving ? t("resolving") : busy === "install" ? t("installing") : t("install"))
        ),
        ...
        resolved && resolved.type === "github" ? import_react2.default.createElement(
          ...
          resolved.candidates.map(
            (c) => import_react2.default.createElement(
              "div",
              { key: c.fullName, className: "pmgr-search-item" },
              import_react2.default.createElement(
                "div",
                { className: "pmgr-search-item-info" },
                import_react2.default.createElement("a", { className: "pmgr-search-item-name", href: c.htmlUrl, target: "_blank", rel: "noreferrer", title: c.fullName }, c.fullName),
                import_react2.default.createElement("span", { className: "pmgr-search-item-stars" }, "\u2B50 " + c.stars),
                c.description ? import_react2.default.createElement("p", { className: "pmgr-search-item-desc" }, c.description) : null
              ),
              import_react2.default.createElement(
                "button",
        ...
        results && results.ok && Array.isArray(results.items) && results.items.length > 0 ? import_react2.default.createElement(
          "div",
          { className: "pmgr-search-results" },
          results.items.map(
            (r) => import_react2.default.createElement(
              "div",
