...
function PluginManagerTab() {
  ...
  const renderRow = (p) => {
    const stateBadge = p.missing ? import_react.default.createElement(Badge, { kind: "state-missing" }, "\u5931\u6548") : p.disabled ? import_react.default.createElement(Badge, { kind: "state-off" }, "\u5DF2\u505C\u7528") : p.mounted ? import_react.default.createElement(Badge, { kind: "state-on" }, "\u5DF2\u88C5\u8F7D") : import_react.default.createElement(Badge, { kind: "state-off" }, "\u672A\u88C5\u8F7D");
